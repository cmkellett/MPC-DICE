...
% -------------------------------------------------------------------------
%
% This is a template script file containing default values from DICE2013R.
% 
% -------------------------------------------------------------------------
...
% Constants
    ...
    %   MPC-DICE uses standard row-column indexing.  The diffusion
    ...
    Params.optlsrv = (Params.deltaK + .004)/(Params.deltaK ...
